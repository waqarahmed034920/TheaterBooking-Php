 					...
 					<div class="card bg-light mt-2">
 						...
 						<div class="card-body">
 							...
 							<form action="" id="save-reserve">
 								...
 								<div class="row">
 									<button class="col-md-2 btn btn-block btn-primary"  type="cancel">Book</button>
									 
									 <input type="button" value="cancel" class="col-md-2 btn btn-block btn-primary" onClick="document.location.href='http://localhost:81/online%20movie%20booking%20theater/';" />
 								</div>
 							</form>
